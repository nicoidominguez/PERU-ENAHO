...
*/
/*
use		"$id\2004\Files\DTA\enaho01a-2004-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// str

use		"$id\2005\Files\DTA\enaho01a-2005-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// str

use		"$id\2006\Files\DTA\enaho01a-2006-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// str

use		"$id\2007\Files\DTA\enaho01a-2007-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// str

use		"$id\2008\Files\DTA\enaho01a-2008-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// float

use		"$id\2009\Files\DTA\enaho01a-2009-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d	// str
desc	p500b1 p500d1			// int

use		"$id\2016\Files\DTA\enaho01a-2016-500.dta", clear
drop	a*o ubigeo dominio estrato p500n p500i p559* t559* z559* d559* i559* ///
		p59f* p560* d560* i560* p20* p301a
desc	p500a p500b p500c p500d // str
desc	p500b1 p500d1			// int
...
********Correspondencia de 'fecha de nacimiento' con 'edad'
gen		redad=anho-nac_anho		if nac_anho!=.&nac_mes!=.&(nac_mes< ent_mes)
replace	redad=anho-nac_anho-1	if nac_anho!=.&nac_mes!=.&(nac_mes> ent_mes)
replace	redad=anho-nac_anho		if nac_anho!=.&nac_mes!=.&(nac_mes==ent_mes)&(nac_dia< ent_dia)
replace	redad=anho-nac_anho-1	if nac_anho!=.&nac_mes!=.&(nac_mes==ent_mes)&(nac_dia>=ent_dia)
replace	redad=edad				if nac_anho==.|nac_mes==.
corr	redad edad
gen		x=redad!=edad
tab		x
/*
          x |      Freq.     Percent        Cum.
------------+-----------------------------------
          0 |  1,292,086       98.87       98.87
          1 |     14,728        1.13      100.00
------------+-----------------------------------
      Total |  1,306,814      100.00
*/
drop	x
gen		x=redad-edad
recode	x (0=.)
...
-------------------------------------------------------------
 ...
 5%           -4            -25
10%           -1            -25       Obs               14728
25%           -1            -25       Sum of Wgt.       14728

50%            1                      Mean          -.0274307
                        Largest       Std. Dev.      3.606191
75%            1             25
90%            1             26       Variance       13.00461
95%            4             27       Skewness      -.3259416
99%           12             29       Kurtosis       16.58854
*/
drop	x
...
/*
summ	p513* p518* p519* p520, sep(0)
desc	p513* p518* p519* p520
tabmiss p513 p513t	if ila!=.
tabmiss p513 p513t	if ip!=.
tabmiss p518		if is!=.
tabmiss p513 p513t p518 p519 p520	if ila!=.
tabmiss p513 p513t p518 p519 p520	if ila!=.&p519==1

tabmiss p513t					if p507>=1&p507<=4|p507==6			 /* Ocu. Principal: Dependientes e Independientes */

tabmiss i524e1 i530a d529t d536 if (p507>=1&p507<=4|p507==6)&p510==1 /* FFAA: ingresos */
tabmiss p513t					if (p507>=1&p507<=4|p507==6)&p510==1 /* FFAA: horas */

tab		p5111					if (p507>=1&p507<=4|p507==6)&p510!=1 /* FFAA: ingresos */
tab		p51111					if (p507>=1&p507<=4|p507==6)&p510!=1 /* FFAA: ingresos */
tab		p51112					if (p507>=1&p507<=4|p507==6)&p510!=1 /* FFAA: ingresos */

tabmiss i524e1 i530a d529t d536 if (p5111 ==1)
tabmiss i524e1 i530a d529t d536 if (p5112 ==1)
tabmiss i524e1 i530a d529t d536 if (p5113 ==1)
tabmiss i524e1 i530a d529t d536 if (p5114 ==1)
tabmiss i524e1 i530a d529t d536 if (p5115 ==1)
tabmiss i524e1 i530a d529t d536 if (p5116 ==1)
tabmiss i524e1 i530a d529t d536 if (p5117 ==1)
tabmiss i524e1 i530a d529t d536 if (p5118 ==1)
tabmiss i524e1 i530a d529t d536 if (p5119 ==1)
tabmiss i524e1 i530a d529t d536 if (p51110==1)
tabmiss i524e1 i530a d529t d536 if (p51111==1)
tabmiss i524e1 i530a d529t d536 if (p51112==1)
tabmiss p513t					if (p507>=1&p507<=4|p507==6)&p510!=1&(p51111==1|p51112==1) /* No FFAA: horas */
*/
